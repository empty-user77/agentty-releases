...
<p align="center">
  ...
  <img alt="Download: about 20MB" src="https://img.shields.io/badge/download-~20MB-brightgreen.svg">
</p>
...
> ~20MB download · no Electron · 13+ agent CLIs · one window for all of them
...
> 약 20MB 다운로드 · Electron 없음 · 13종 이상의 에이전트 CLI · 전부 한 창에서
...
> 約 20MB のダウンロード · Electron なし · 13 種類以上のエージェント CLI · すべてをひとつのウィンドウで
...
> 约 20MB 下载 · 无 Electron · 13+ 种智能体 CLI · 全部集中在一个窗口
